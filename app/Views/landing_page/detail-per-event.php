...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/css/landing_page/detail-per-event/event.css">
</head>
    ...
    <main class="text-white">
        <section class="container row align-items-center mx-auto position-relatve">
            <div class="col-md-6">
                ...
                <a href="#" class="btn btn-primary px-4 py-3 mt-4 rounded-pill">Download Guide Book</a>
                <a href="#" class="btn btn-primary px-4 py-3 mt-4 ms-4 rounded-pill">Daftar CTF</a>
            </div>
            <div class="col-md-6">
