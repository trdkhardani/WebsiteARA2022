<footer data-aos="fade-down" data-aos-duration="2000" class="container-fluid py-5">
    ...
    <div class="mx-auto text-center d-flex justify-content-center">
        <a class="sosial-media mx-2 rounded-circle" target="_blank" href="https://www.instagram.com/ara_its/" rel="nofollow"><i class="fab fa-instagram"></i></a>
        <a class="sosial-media mx-2 rounded-circle" target="_blank" href="https://www.youtube.com/channel/UChWjgJMQIYVivMx_gIy1eDA" rel="nofollow"><i class="fab fa-youtube"></i></a>
        <a class="sosial-media mx-2 rounded-circle" target="_blank" href="https://vt.tiktok.com/ZSe7r9nLL/" rel="nofollow"><i class="fab fa-tiktok"></i></a>
    </div>
