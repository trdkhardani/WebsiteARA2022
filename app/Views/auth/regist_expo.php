  ...
  <div class="container w-50 p-3 wrapper-main">
    ...
    <main>
      ...
      <?= csrf_field() ?>
        ...
        <div class="mb-3">
          <label for="share_post" class="form-label">Share Post Expo IT di Story IG dan tag 3 temanmu <span class="text-danger">*<?= '<br>' . $validation->getError('share_post') ?></span></label>
