    ...
    <tbody>
      ...
      <?php foreach ($list_tim_full_paper as $tim) : ?>
        <tr>
          ...
          <td>
            <a href="" class="btn btn-sm btn-success" data-bs-toggle="modal" data-bs-target="#modalTerima" onclick="document.getElementById('buttTerima').href = '<?= base_url() ?>/dashboard/Admin_kti_iot/verify_konfirmasi_final/<?= $tim['iot_id'] ?>/1';">Terima</a>
            <a href="" class="btn btn-sm btn-danger" data-bs-toggle="modal" data-bs-target="#modalTolak" onclick="document.getElementById('buttTolak').href = '<?= base_url() ?>/dashboard/Admin_kti_iot/verify_konfirmasi_final/<?= $tim['iot_id'] ?>/0';">Tolak</a>
            <!-- <form action="/dashboard/Admin_kti_iot/verify_konfirmasi_final" method="post">
