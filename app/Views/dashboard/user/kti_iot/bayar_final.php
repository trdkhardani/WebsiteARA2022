...
<div class="card-dashboard">
  <h4>Informasi</h4>
  <ul>
    <li><i class="fas fa-clock"></i> Deadline Pembayaran: 29 Mei - 3 Juni</li>
  </ul>
</div>
<!-- Upload Bukti Pembayaran -->
<?php if (!$pembayaran_final) : ?>
  <div class="card-dashboard">
    ...
    <ul>
      ...
      <li>
        <form action="<?= base_url() ?>/dashboard/User_kti_iot/payment_final" method="POST" enctype="multipart/form-data">
          <div class="mb-4">
